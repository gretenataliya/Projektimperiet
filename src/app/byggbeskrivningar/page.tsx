...
export default function ByggbeskrivningarPage() {
  return (
    <>
      <Header />
        ...
        <section className="relative overflow-hidden bg-black py-32 text-white">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/70">
              Vi tar fram professionella tekniska beskrivningar och dokumentation
              som skapar tydlighet genom hela projektet.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <h2 className="text-4xl font-bold tracking-tight text-black">
                Tydliga handlingar för tryggare projekt
              </h2>

              <div className="mt-8 space-y-6 text-lg leading-8 text-black/70">
                <p>
                  Byggbeskrivningar är en viktig del av ett tydligt och
                  välstrukturerat byggprojekt.
                </p>

                <p>
                  Vi hjälper till att ta fram tekniska beskrivningar och
                  dokumentation som skapar samsyn mellan beställare,
                  entreprenörer och övriga projektparter.
                </p>

                <p>
                  Tydliga handlingar minskar risken för missförstånd, fel och
                  kostsamma ändringar under projektets gång.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-[2rem] bg-[#F8F6F2] p-8">
              ...
              <div className="space-y-5">
                {[
                  ...
                  "Tydliga projekthandlingar",
                  "Granskning av beskrivningar",
                  "Stöd genom projektet",
                ].map((item) => (
