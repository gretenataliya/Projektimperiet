...
export default function ForstudierProjektanalyserPage() {
  return (
    <>
      <Header />
        ...
        <section className="relative overflow-hidden bg-black py-32 text-white">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/70">
              Vi utreder möjligheter, risker, kostnader och tekniska
              förutsättningar innan projektstart.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <h2 className="text-4xl font-bold tracking-tight text-black">
                Rätt beslut innan projektet startar
              </h2>

              <div className="mt-8 space-y-6 text-lg leading-8 text-black/70">
                <p>
                  En väl genomförd förstudie ger bättre kontroll över projektets
                  möjligheter, risker och ekonomiska förutsättningar.
                </p>

                <p>
                  Projektimperiet AB hjälper till att analysera projektets
                  omfattning, tekniska krav, budget och genomförbarhet innan
                  större beslut tas.
                </p>

                <p>
                  Målet är att skapa ett tydligt beslutsunderlag som minskar
                  osäkerhet och ger projektet rätt start.
                </p>
              </div>
            </div>
