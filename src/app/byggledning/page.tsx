...
export default function ByggledningPage() {
  return (
    <>
      <Header />
        ...
        <section className="relative overflow-hidden bg-black py-32 text-white">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <h1 className="max-w-4xl text-5xl font-bold tracking-tight md:text-7xl">
              Byggledning för trygga entreprenader
            </h1>

            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/70">
              Vi representerar beställaren ute i produktionen och säkerställer
              att entreprenaden genomförs enligt avtal, kvalitet och tidplan.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <h2 className="text-4xl font-bold tracking-tight text-black">
                Byggledning med fokus på kvalitet och kontroll
              </h2>

              <div className="mt-8 space-y-6 text-lg leading-8 text-black/70">
                <p>
                  Vi fungerar som beställarens representant ute på byggplatsen
                  och säkerställer att projektet genomförs enligt överenskomna
                  krav och förutsättningar.
                </p>

                <p>
                  Genom aktiv närvaro, tydlig kommunikation och teknisk kompetens
                  hjälper vi till att minimera fel, förseningar och kostsamma
                  avvikelser.
                </p>

                <p>
                  Vi arbetar nära entreprenörer, konsulter och beställare för att
                  skapa effektiva och välfungerande byggprocesser.
                </p>
              </div>
            </div>
